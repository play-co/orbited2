...
filePath:"jsio/std/JSON.js"},"net.env.browser.websocket":{src:'jsio("import net.interfaces");jsio("import std.utf8 as utf8");exports.Connector=Class(net.interfaces.Connector,function(){this.connect=function(){var a=this._opts.url,b=this._opts.wsConstructor||window.WebSocket;logger.info("this._opts",this._opts);var c=new b(a);c.onopen=bind(this,function(){this.onConnect(new Transport(c))});c.onclose=bind(this,function(d){logger.debug("conn closed without opening, code:",d)})}});\nvar Transport=Class(net.interfaces.Transport,function(){this.init=function(a){this._ws=a};this.makeConnection=function(a){this._ws.onmessage=function(b){b=utf8.encode(b.data);a.dataReceived(b)};this._ws.onclose=bind(a,"connectionLost")};this.write=function(a){if(this._encoding=="plain"){result=utf8.decode(a);a=result[0]}this._ws.send(a)};this.loseConnection=function(){this._ws.close()}});\n',
...
"undefined"&&process.version)jsio.setEnv("node");else if(typeof XMLHttpRequest!="undefined"||typeof ActiveXObject!="undefined")jsio.setEnv("browser")})();jsio("import Orbited2 as Orbited2");
