...
a=null,d=null;this.global=window;this.global.jsio=jsio;this.log=function(){var f=c.call(arguments,0);if(typeof console!="undefined"&&console.log)console.log.apply?console.log.apply(console,arguments):console.log(f);return f.join(" ")};this.getCwd=function(){if(!a){var f=window.location.toString();a=f.substring(0,f.lastIndexOf("/")+1)}return a};this.getPath=function(){if(!d){try{for(var f=RegExp("(.*?)"+jsio.__filename+"(\\?.*)?$"),k=document.getElementsByTagName("script"),e=0,h;h=k[e];++e){var l=
...
0)){e.src=h.responseText;return e}}return false}}function B(b,c){var a=i.eval("(function(_){with(_){delete _;(function(){"+c.src+"\n}).call(this)}})",c.filePath);try{a.call(b.exports,b)}catch(d){if(d.type=="syntax_error")throw Error("error importing module: "+d.message);else d.type=="stack_overflow"?i.log("Stack overflow in",c.filePath,":",d):i.log("ERROR LOADING",c.filePath,":",d);throw d;}}function x(b,c,a){if(!c||(a=a||".")!=b.charAt(0))return b;for(var d=1;b.charAt(d)==a;)++d;c=c.split(a).slice(0,
-d);if(c.length){c=c.join(a);if(c.charAt(c.length-1)!=a)c+=a}return c+b.substring(d)}function I(b,c){var a,d=[];if(a=c.match(/^(from|external)\s+([\w.$]+)\s+import\s+(.*)$/)){d[0]={from:x(a[2],b),external:a[1]=="external","import":{}};a[3].replace(/\s*([\w.$*]+)(?:\s+as\s+([\w.$]+))?/g,function(f,k,e){d[0]["import"][k]=e||k})}else if(a=c.match(/^import\s+(.*)$/))a[1].replace(/\s*([\w.$]+)(?:\s+as\s+([\w.$]+))?,?/g,function(f,k,e){fullPkg=x(k,b);d[d.length]=e?{from:fullPkg,as:e}:{from:fullPkg,as:k}});
else if(a=c.match(/[\w.0-9$\/]/)){a=a[0];var g=a.charAt(0)=="/";a=a.replace(/^\//,"").replace(/\.\.?\//g,".").replace(/\//g,".");d[0]={from:g?a:x(a,b),as:a}}else{a="Invalid jsio request: jsio('"+c+"')";throw SyntaxError?new SyntaxError(a):Error(a);}return d}function J(b,c){var a={exports:{},global:i.global},d=i.getCwd(),g=c.lastIndexOf("/"),f=g>0;a.require=a.jsio=z(this,C,a,b);a.module={id:b};if(b!="base"){a.jsio("from base import *");a.logging.__create(b,a)}a.jsio.__jsio=jsio;a.jsio.__env=jsio.__env;
a.jsio.__dir=f?A(c.substring(0,g),d):"";a.jsio.__filename=f?c.substring(g):c;a.jsio.__path=b;return a}function A(b,c){var a=b.match("^"+c);if(a&&a[0]==c)return b.slice(c.length+(b[c.length]=="/"?1:0));return b}function C(b,c,a,d){b=d||b||i.global;d=I(c,a);for(var g=d.length,f=g>1?{}:null,k=0;k<g;++k){var e=d[k],h=e.from,l=jsio.modules;if(!(h in l)){try{var o;if(!(o=y[h])){var n=h,q;var j=n;if(j.charAt(0)=="."){for(var m=0;j.charAt(m+1)==".";)++m;var u;u=i.getCwd().replace(/\/$/,"");if(m)u=u.split("/").slice(0,
-m).join("/");q=[{filePath:u+"/"+j.substring(m+1).split(".").join("/")+".js"}]}else{var D=j.split("."),r=D[0],E=D.join("/");if(r in jsio.path)q=[{filePath:(jsio.path[r].length&&jsio.path[r].replace(/([^\/])$/,"$1/")||jsio.path[r])+E+".js"}];else{j=[];var v=typeof jsio.path.__default__=="string"?[jsio.path.__default__]:jsio.path.__default__;m=0;for(var K=v.length;m<K;++m){var F=v[m].length&&v[m].replace(/([^\/])$/,"$1/")||v[m];j.push({filePath:F+E+".js",baseMod:r,basePath:F})}q=j}}var s=i.findModule(q);
if(!s){b=[];o=0;for(m=void 0;m=q[o];++o)b.push(m.filePath);throw Error("Module not found: "+n+" (looked in "+b.join(", ")+")");}if(!(s.baseMod in jsio.path))jsio.path[s.baseMod]=s.basePath;o=s}n=o}catch(L){i.log("\nError executing '",a,"': could not load module",h,"\n\tpath:",c,"\n\trequest:",a,"\n");throw L;}if(e.external){j=l[h]={};for(var t in e["import"])j[t]=undefined;B(j,n);for(t in e["import"])if(j[t]===undefined)j[t]=i.global[t]}else{j=J(h,n.filePath);l[h]=j.exports;B(j,n);l[h]=j.exports}}n=
l[h];if(g==1)f=n;if(e.as){h=e.as.match(/^\.*(.*?)\.*$/)[1];e=h.split(".");l=e.length-1;j=b;for(var p=0;p<l;++p){var w=e[p];if(w){j[w]||(j[w]={});j=j[w]}}j[e[l]]=n;if(g>1)f[h]=n}else if(e["import"])if(e["import"]["*"])for(p in l[h])b[p]=n[p];else try{for(p in e["import"])b[e["import"][p]]=n[p]}catch(M){i.log("module: ",l);throw M;}}return f}var i,y={"net.env":{src:'function getObj(c,a,b){try{jsio("from .env."+(b||jsio.__env.name)+"."+a+" import "+c+" as result")}catch(d){throw logger.error("Invalid transport (",a,") or environment (",b,")");}return result}exports.getListener=bind(this,getObj,"Listener");exports.getConnector=bind(this,getObj,"Connector");\n',
filePath:"jsio/net/env.js"},Orbited2:{src:'jsio("from net.protocols.buffered import BufferedProtocol");jsio("import net");jsio("import std.uri");jsio("import std.JSON");jsio("import std.utf8 as utf8");var originalWebSocket=window.WebSocket,baseUri=new std.uri.Uri(window.location),defaultOrbitedUri;\nfunction setup(){for(var a=document.getElementsByTagName("script"),c=0,d;d=a[c];++c)if(d.src.match("(^|/)Orbited.js$")){found=true;a=new std.uri.Uri(d.src.substring(0,d.src.length-10));defaultOrbitedUri=(a.getProtocol()||baseUri.getProtocol())+"://"+(a.getHost()||baseUri.getHost())+":"+(a.getPort()||baseUri.getPort()||"80")+(a.getPath()||baseUri.getPath());break}}setup();var READYSTATE_WAITING=-1,READYSTATE_CONNECTING=0,READYSTATE_OPEN=1,READYSTATE_CLOSING=2,READYSTATE_CLOSED=3;\nexports.TCPSocket=Class(function(){this.init=function(b){this._orbitedUri=b.orbitedUri||defaultOrbitedUri;this._orbitedUri.match("/$")||(this._orbitedUri+="/");this.readyState=READYSTATE_WAITING;this._buffer=""};this.open=function(b,f,g){if(!this._orbitedUri)throw Error("Could not automatically determine Orbited\'s uri, and Orbited.TCPSocket.opts.orbitedUri was not manually specified in TCPSocket constructor");var h=getMultiplexer(this._orbitedUri);this._isBinary=!!g;this._host=b;this._port=f;this._conn=\nh.openConnection();this._conn.onOpen=bind(this,c);this._conn.onFrame=bind(this,d);this._conn.onClose=bind(this,a);this.readyState=READYSTATE_CONNECTING};var a=function(){if(this.readyState!=READYSTATE_CLOSED){this.readyState=READYSTATE_CLOSED;releaseMultiplexer();bind(this,e)("close")}},c=function(){this._conn.send(JSON.stringify({hostname:this._host,port:this._port,protocol:"tcp"}))},d=function(b){switch(this.readyState){case READYSTATE_CONNECTING:if(b=="1"){this.readyState=READYSTATE_OPEN;bind(this,\ne)("open")}else this._onClose();break;case READYSTATE_OPEN:this._buffer+=b;var f=utf8.decode(this._buffer);b=f[0];this._buffer=this._buffer.slice(f[1]);b.length&&bind(this,e)("read",b);break}};this.send=function(b){if(!(this.readyState>=READYSTATE_CLOSING)){this._isBinary||(b=utf8.encode(b));this._conn.send(b)}};this.close=function(){if(!(this.readyState>=READYSTATE_CLOSING)){this.readyState=READYSTATE_CLOSING;this._conn.close();this._conn.onClose=bind(this,"_onClose")}};var e=function(b,f){var g=\nthis["on"+b];g&&g.call(this,f)}});\nexports.WebSocket=Class(function(){this.init=function(b){this.URL=b;this.readyState=READYSTATE_CONNECTING;this.bufferedAmount=0;this._conn=getMultiplexer(exports.WebSocket.opts.orbitedUri).openConnection();this._conn.onOpen=bind(this,c);this._conn.onFrame=bind(this,d);this._conn.onClose=bind(this,a);this.onopen=this.onmessage=this.onerror=this.onclose=null};this.send=function(b){if(!(this.readyState>=READYSTATE_CLOSING)){b=utf8.encode(b);this._conn.send(b)}};var a=function(){if(this.readyState!=READYSTATE_CLOSED){this.readyState=\nREADYSTATE_CLOSED;releaseMultiplexer();bind(this,e)("close")}},c=function(){var b=new std.uri.Uri(this.URL);this._conn.send(JSON.stringify({hostname:b.getHost(),port:parseInt(b.getPort())||(b.getProtocol()=="ws"?80:443),path:b.getPath()||"/",protocol:"ws_"+exports.WebSocket.opts.protocolVersion}))},d=function(b){switch(this.readyState){case READYSTATE_CONNECTING:if(b=="1"){this.readyState=READYSTATE_OPEN;bind(this,e)("open")}else this._onClose();break;case READYSTATE_OPEN:b=utf8.decode(b);bind(this,\ne)("message",b[0]);break}},e=function(b,f){var g=this["on"+b];g&&g.call(this,{data:f})};this.close=function(){if(!(this.readyState>=READYSTATE_CLOSING)){this.readyState=READYSTATE_CLOSING;this._conn.close();this._conn.onClose=bind(this,a)}}});var installed=false;\nexports.WebSocket.install=function(a){if(installed)throw Error("orbited.Websocket already installed");validateOpts(a);exports.WebSocket.opts=a;installed=true;if(!(!a.forceProxy&&hasNativeWebSocket(a.protocolVersion))){window.WebSocket=exports.WebSocket;window.WebSocket.__original__=originalWebSocket}};\nfunction validateOpts(a){a.protocolVersion=a.protocolVersion||"hixie76";a.forceProxy=!!a.forceProxy;if(!a.orbitedUri)a.orbitedUri=defaultOrbitedUri;if(!a.orbitedUri)throw Error("orbitedUri not specified; unable to auto-detect it based on script tag includes");a.orbitedUri.match("/$")||(a.orbitedUri+="/")}\nfunction hasNativeWebSocket(a){if(!originalWebSocket)return false;if(!a)return true;if(navigator.userAgent.match("Chrome/5"))return a=="hixie75";if(navigator.userAgent.match("Chrome/6"))return a=="hixie76";if(navigator.userAgent.match("Version/5.0 Safari"))return a=="hixie75";return false}var multiplexer=null,count=0;\nfunction getMultiplexer(a){if(!multiplexer){multiplexer=new OrbitedMultiplexingProtocol(a);multiplexer.onClose=function(){multiplexer=null};if(originalWebSocket){a=new std.uri.Uri(a);a.setProtocol("ws");a=a.render()+"ws";net.connect(multiplexer,"websocket",{url:a,wsConstructor:originalWebSocket});multiplexer.connectionLost=bind(multiplexer,"_connectionLost","websocket");multiplexer.mode="ws"}else{net.connect(multiplexer,"csp",{url:a+"csp"});multiplexer.mode="csp";multiplexer.connectionLost=bind(multiplexer,\n"_connectionLost","csp")}}count+=1;return multiplexer}function releaseMultiplexer(){if(--count==0){multiplexer.transport.loseConnection();multiplexer=null}}var OPEN_FRAME=0,CLOSE_FRAME=1,DATA_FRAME=2;DELIMITER=",";\nvar Connection=Class(function(){this.init=function(a,c){this._multiplexer=a;this._id=c};this.send=function(a){this._id=id;this._multiplexer.sendFrame(this._id,DATA_FRAME,a)};this.close=function(){this._multiplexer.closeConnection(this._id)};this.onFrame=function(){};this.onClose=function(){};this.onOpen=function(){}}),OrbitedMultiplexingProtocol=Class(BufferedProtocol,function(a){this.init=function(c){a(this,"init",arguments);this._baseUri=c;this._connections={};this._size=this._last_id=-1;this._connected=\nfalse};this.openConnection=function(){var c=++this._last_id,d=this._connections[c]=new Connection(this,c);this._connected&&this._sendOpen(c);return d};this.closeConnection=function(c){this._connections[c]&&this._connected&&this._sendClose(c)};this._sendOpen=function(c){this.sendFrame(c,OPEN_FRAME)};this._sendClose=function(c){this.sendFrame(c,CLOSE_FRAME)};this.sendFrame=function(c,d,e){e=e||"";if(!this._connected)throw Error("Multiplexer not connected");c=c+DELIMITER+d+DELIMITER+e;this.transport.write(c.length+\nDELIMITER+c)};this.connectionMade=function(){this._connected=true;for(id in this._connections)this._sendOpen(id)};this.onClose=function(){};this._connectionLost=function(c,d,e){if(e)this.onClose();else if(c=="websocket"){net.connect(this,"csp",{url:this._baseUri+"csp"});this.connectionLost=bind(this,"_connectionLost","csp");this.mode="csp"}};this._dispatchPayload=function(c){var d=c.indexOf(DELIMITER);if(d!=-1){var e=parseInt(c.substring(0,d)),b=c.indexOf(DELIMITER,d+1);if(b!=-1){d=parseInt(c.substring(d+\n1,b));c=c.substring(b+1);b=this._connections[e];if(!(!b||typeof d!="number"))switch(d){case OPEN_FRAME:b.onOpen();break;case CLOSE_FRAME:delete this._connections[e];b.onClose();break;case DATA_FRAME:b.onFrame(c);break}}}};this.bufferUpdated=function(){for(;;){if(this._size==-1)if(this.buffer.hasDelimiter(DELIMITER)){this._size=parseInt(this.buffer.consumeToDelimiter(DELIMITER));this.buffer.consumeBytes(DELIMITER.length)}else break;if(!this.buffer.hasBytes(this._size))break;this._dispatchPayload(this.buffer.consumeBytes(this._size));\nthis._size=-1}}});\n',
filePath:"Orbited2.js"},"std.base64":{src:'for(var alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_",pad="=",padChar=alphabet.charAt(alphabet.length-1),shorten=function(a,b){for(var c=b;c>0;c--)a.pop()},decode_map={},i=0,n=alphabet.length;i<n;i++)decode_map[alphabet.charAt(i)]=i;var alphabet_inverse=RegExp("[^"+alphabet.replace("-","\\\\-")+"]"),Base64CodecError=exports.Base64CodecError=function(a){this.message=a};\nBase64CodecError.prototype.toString=function(){return"Base64CodecError"+(this.message?": "+this.message:"")};var assertOrBadInput=function(a,b){if(!a)throw new Base64CodecError(b);};\nexports.encode=function(a){assertOrBadInput(!/[^\\x00-\\xFF]/.test(a),"Input contains out-of-range characters.");var b="\\u0000\\u0000\\u0000".slice(a.length%3||3);a+=b;for(var c=[],d=0,f=a.length;d<f;d+=3){var e=(a.charCodeAt(d)<<16)+(a.charCodeAt(d+1)<<8)+a.charCodeAt(d+2);c.push(alphabet.charAt(e>>18&63),alphabet.charAt(e>>12&63),alphabet.charAt(e>>6&63),alphabet.charAt(e&63))}shorten(c,b.length);return c.join("")};\nexports.decode=function(a){logger.debug("decode",a);a=a.replace(/\\s/g,"");for(var b=a.length;a.charAt(--b)===pad;);a=a.slice(0,b+1);assertOrBadInput(!alphabet_inverse.test(a),"Input contains out-of-range characters.");var c=Array(5-(a.length%4||4)).join(padChar);a+=c;var d=[];b=0;for(var f=a.length;b<f;b+=4){newchars=(decode_map[a.charAt(b)]<<18)+(decode_map[a.charAt(b+1)]<<12)+(decode_map[a.charAt(b+2)]<<6)+decode_map[a.charAt(b+3)];d.push(newchars>>16&255,newchars>>8&255,newchars&255)}shorten(d,\nc.length);a=String.fromCharCode.apply(String,d);logger.debug("decoded",a);return a};\n',
...
jsio.setPath(i.getPath())}};if(typeof process!=="undefined"&&process.version)jsio.setEnv("node");else if(typeof XMLHttpRequest!="undefined"||typeof ActiveXObject!="undefined")jsio.setEnv("browser")})();jsio("import Orbited2 as Orbited2");
